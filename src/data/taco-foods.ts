...
export const TACO_FOODS: readonly TacoFood[] = [
  ...
  },
  {
    ...
    // v0.6.2: 'açaí na tigela' + 'acai bowl' moved to taco_id 392 (full bowl with toppings).
    aliases: ["açaí", "acai", "açaí polpa", "acai polpa", "açaí congelado"],
  },
  {
  ...
  { taco_id: 575, name_pt: "Refrigerante, cola, regular", name_en: "Cola soda, regular", category: "bebidas",
    ...
    // v0.6.2: removed 'guaraná' alias — guaraná is a distinct soda (see taco_id: 588).
    aliases: ["coca cola", "coca-cola", "refrigerante cola", "cola"] },
  ...
  // --- v0.6.2 expansion: 30 commonly-missing Brazilian regional foods ---
  // Sources: TACO 4 (NEPA/UNICAMP) primary; gaps filled from IBGE POF 2017-18
  // food consumption tables and USDA SR Legacy cross-reference. taco_id 700+
  // is reserved for entries that ship in this curated subset but were not
  // present in the original 597-row publication (regional specialties).

  // --- Cereais (regional cassava + corn dishes) ---
  { taco_id: 117, name_pt: "Farinha de mandioca, crua, torrada", name_en: "Cassava flour, toasted", category: "cereais_e_derivados",
    nutrients_per_100g: { calories_kcal: 365, protein_g: 1.2, carbohydrates_g: 87.9, fat_g: 0.3, fiber_g: 6.4, sodium_mg: 2 },
    common_serving: { label_pt: "2 colheres de sopa (~25g)", grams: 25 },
    aliases: ["farinha de mandioca", "farinha", "farinha torrada", "cassava flour", "manioc flour"] },
  { taco_id: 118, name_pt: "Polvilho azedo", name_en: "Sour cassava starch", category: "cereais_e_derivados",
    nutrients_per_100g: { calories_kcal: 361, protein_g: 0.2, carbohydrates_g: 89.5, fat_g: 0.1, fiber_g: 0.5, sodium_mg: 2 },
    common_serving: { label_pt: "1 colher de sopa (~12g)", grams: 12 },
    aliases: ["polvilho", "polvilho azedo", "polvilho doce", "sour starch", "tapioca starch"] },
  { taco_id: 119, name_pt: "Biscoito de polvilho", name_en: "Cassava-starch biscuit", category: "cereais_e_derivados",
    nutrients_per_100g: { calories_kcal: 422, protein_g: 1.1, carbohydrates_g: 75.4, fat_g: 12.6, fiber_g: 0.6, sodium_mg: 320 },
    common_serving: { label_pt: "1 punhado (~20g)", grams: 20 },
    aliases: ["biscoito de polvilho", "biscoito polvilho", "polvilho biscoito", "cassava biscuit"] },
  { taco_id: 120, name_pt: "Pamonha, milho verde, doce", name_en: "Pamonha (sweet corn pudding)", category: "cereais_e_derivados",
    nutrients_per_100g: { calories_kcal: 178, protein_g: 3.0, carbohydrates_g: 30.5, fat_g: 5.5, fiber_g: 2.1, sugar_g: 11.0, sodium_mg: 38 },
    common_serving: { label_pt: "1 unidade (~150g)", grams: 150 },
    aliases: ["pamonha", "pamonha doce", "pamonha de milho", "corn pudding wrap"] },
  { taco_id: 121, name_pt: "Curau de milho", name_en: "Curau (corn cream pudding)", category: "cereais_e_derivados",
    nutrients_per_100g: { calories_kcal: 165, protein_g: 3.2, carbohydrates_g: 27.6, fat_g: 4.8, fiber_g: 1.5, sugar_g: 17.0, sodium_mg: 40 },
    common_serving: { label_pt: "1 porção (~120g)", grams: 120 },
    aliases: ["curau", "curau de milho", "canjica nordestina", "corn cream pudding"] },
  { taco_id: 122, name_pt: "Canjica branca, com leite", name_en: "Canjica (white hominy with milk)", category: "cereais_e_derivados",
    nutrients_per_100g: { calories_kcal: 174, protein_g: 4.1, carbohydrates_g: 27.8, fat_g: 5.3, fiber_g: 1.8, sugar_g: 13.0, sodium_mg: 28 },
    common_serving: { label_pt: "1 porção (~200g)", grams: 200 },
    aliases: ["canjica", "canjica branca", "mungunzá", "munguza", "hominy"] },

  // --- Leguminosas (regional bean preparations) ---
  { taco_id: 159, name_pt: "Feijão tropeiro mineiro", name_en: "Feijão tropeiro (beans, sausage, eggs)", category: "leguminosas_e_derivados",
    nutrients_per_100g: { calories_kcal: 215, protein_g: 10.8, carbohydrates_g: 21.0, fat_g: 9.5, fiber_g: 5.5, sodium_mg: 580 },
    common_serving: { label_pt: "1 concha (~150g)", grams: 150 },
    aliases: ["feijão tropeiro", "feijao tropeiro", "tropeiro", "tropeiro mineiro"] },
  { taco_id: 160, name_pt: "Baião de dois", name_en: "Baião de dois (rice and beans)", category: "leguminosas_e_derivados",
    nutrients_per_100g: { calories_kcal: 175, protein_g: 6.4, carbohydrates_g: 28.5, fat_g: 4.2, fiber_g: 3.6, sodium_mg: 320 },
    common_serving: { label_pt: "1 prato (~250g)", grams: 250 },
    aliases: ["baião de dois", "baiao de dois", "baião"] },

  // --- Carnes (regional pork/beef + Bahian/Northeast specialties) ---
  { taco_id: 412, name_pt: "Carne seca, dessalgada, cozida", name_en: "Jerked beef, cooked, desalted", category: "carnes_e_derivados",
    nutrients_per_100g: { calories_kcal: 195, protein_g: 30.8, carbohydrates_g: 0, fat_g: 7.6, sodium_mg: 720 },
    common_serving: { label_pt: "1 porção (~80g)", grams: 80 },
    aliases: ["carne seca", "carne de sol", "jerked beef", "carne seca cozida"] },
  { taco_id: 413, name_pt: "Paçoca de carne seca", name_en: "Paçoca de carne seca (jerked beef and cassava-flour mash)", category: "carnes_e_derivados",
    nutrients_per_100g: { calories_kcal: 280, protein_g: 22.0, carbohydrates_g: 22.0, fat_g: 11.5, fiber_g: 3.2, sodium_mg: 850 },
    common_serving: { label_pt: "1 porção (~100g)", grams: 100 },
    aliases: ["paçoca de carne", "pacoca de carne", "paçoca de carne seca", "paçoca nordestina"] },
  { taco_id: 421, name_pt: "Arroz carreteiro", name_en: "Arroz carreteiro (rice with jerked beef)", category: "carnes_e_derivados",
    nutrients_per_100g: { calories_kcal: 168, protein_g: 9.2, carbohydrates_g: 22.4, fat_g: 4.6, fiber_g: 0.8, sodium_mg: 420 },
    common_serving: { label_pt: "1 prato (~250g)", grams: 250 },
    aliases: ["arroz carreteiro", "carreteiro", "arroz com carne seca"] },
  { taco_id: 425, name_pt: "Escondidinho de carne seca", name_en: "Escondidinho (cassava and jerked beef shepherd's pie)", category: "carnes_e_derivados",
    nutrients_per_100g: { calories_kcal: 190, protein_g: 9.0, carbohydrates_g: 22.0, fat_g: 7.5, fiber_g: 2.0, sodium_mg: 410 },
    common_serving: { label_pt: "1 porção (~200g)", grams: 200 },
    aliases: ["escondidinho", "escondidinho de carne", "escondidinho de carne seca", "shepherds pie cassava"] },

  // --- Pescados (Bahian, Pará specialties) ---
  { taco_id: 484, name_pt: "Acarajé, frito em azeite de dendê", name_en: "Acarajé (black-eyed pea fritter in palm oil)", category: "pescados",
    nutrients_per_100g: { calories_kcal: 310, protein_g: 9.5, carbohydrates_g: 21.5, fat_g: 21.0, fiber_g: 6.0, sodium_mg: 460 },
    common_serving: { label_pt: "1 unidade (~110g)", grams: 110 },
    aliases: ["acarajé", "acaraje", "acarajé baiano", "bean fritter"] },
  { taco_id: 485, name_pt: "Vatapá", name_en: "Vatapá (Bahian shrimp and bread stew)", category: "pescados",
    nutrients_per_100g: { calories_kcal: 215, protein_g: 8.0, carbohydrates_g: 14.0, fat_g: 14.5, fiber_g: 1.4, sodium_mg: 450 },
    common_serving: { label_pt: "1 porção (~150g)", grams: 150 },
    aliases: ["vatapá", "vatapa", "vatapá baiano"] },
  { taco_id: 486, name_pt: "Caruru", name_en: "Caruru (okra stew with shrimp and dendê)", category: "pescados",
    nutrients_per_100g: { calories_kcal: 175, protein_g: 9.5, carbohydrates_g: 9.0, fat_g: 11.5, fiber_g: 3.5, sodium_mg: 420 },
    common_serving: { label_pt: "1 porção (~150g)", grams: 150 },
    aliases: ["caruru", "caruru baiano", "okra stew"] },
  { taco_id: 487, name_pt: "Bobó de camarão", name_en: "Bobó de camarão (shrimp in cassava cream)", category: "pescados",
    nutrients_per_100g: { calories_kcal: 165, protein_g: 9.2, carbohydrates_g: 11.5, fat_g: 9.0, fiber_g: 1.9, sodium_mg: 380 },
    common_serving: { label_pt: "1 porção (~200g)", grams: 200 },
    aliases: ["bobó de camarão", "bobo de camarao", "bobó", "shrimp cassava cream"] },
  { taco_id: 488, name_pt: "Moqueca baiana de peixe", name_en: "Moqueca baiana (fish stew with dendê and coconut milk)", category: "pescados",
    nutrients_per_100g: { calories_kcal: 145, protein_g: 14.0, carbohydrates_g: 4.0, fat_g: 8.5, fiber_g: 0.8, sodium_mg: 380 },
    common_serving: { label_pt: "1 porção (~250g)", grams: 250 },
    aliases: ["moqueca", "moqueca baiana", "moqueca de peixe", "fish moqueca"] },
  { taco_id: 489, name_pt: "Tucupi, caldo amarelo", name_en: "Tucupi (Amazonian fermented cassava broth)", category: "pescados",
    nutrients_per_100g: { calories_kcal: 30, protein_g: 0.5, carbohydrates_g: 6.5, fat_g: 0.1, sodium_mg: 240 },
    common_serving: { label_pt: "1 concha (~150g)", grams: 150 },
    aliases: ["tucupi", "caldo de tucupi", "yellow cassava broth"] },

  // --- Bebidas (regional drinks) ---
  { taco_id: 588, name_pt: "Refrigerante, guaraná, regular", name_en: "Guaraná soda, regular", category: "bebidas",
    nutrients_per_100g: { calories_kcal: 43, protein_g: 0, carbohydrates_g: 10.8, fat_g: 0, sugar_g: 10.8, sodium_mg: 6 },
    common_serving: { label_pt: "1 lata (~350 ml)", grams: 350 },
    aliases: ["guaraná", "guarana", "guaraná natural", "refrigerante guaraná", "antarctica guaraná"] },
  { taco_id: 589, name_pt: "Chá mate gelado, com açúcar", name_en: "Mate iced tea, with sugar", category: "bebidas",
    nutrients_per_100g: { calories_kcal: 32, protein_g: 0, carbohydrates_g: 8.0, fat_g: 0, sugar_g: 8.0, sodium_mg: 6 },
    common_serving: { label_pt: "1 copo (~300 ml)", grams: 300 },
    aliases: ["mate gelado", "chá mate", "cha mate gelado", "iced mate"] },
  { taco_id: 590, name_pt: "Chocolate quente, com leite integral", name_en: "Hot chocolate, with whole milk (Brazilian-style)", category: "bebidas",
    nutrients_per_100g: { calories_kcal: 85, protein_g: 3.2, carbohydrates_g: 11.4, fat_g: 3.2, sugar_g: 10.8, sodium_mg: 42 },
    common_serving: { label_pt: "1 xícara (~200 ml)", grams: 200 },
    aliases: ["chocolate quente", "chocolate quente brasileiro", "hot chocolate", "achocolatado quente"] },
  { taco_id: 591, name_pt: "Caldo de cana", name_en: "Sugarcane juice", category: "bebidas",
    nutrients_per_100g: { calories_kcal: 70, protein_g: 0, carbohydrates_g: 18.5, fat_g: 0, sugar_g: 18.0, sodium_mg: 2 },
    common_serving: { label_pt: "1 copo (~250 ml)", grams: 250 },
    aliases: ["caldo de cana", "garapa", "sugarcane juice"] },

  // --- Frutas e derivados (Amazon/Cerrado fruits) ---
  { taco_id: 392, name_pt: "Açaí na tigela, com xarope de guaraná e banana", name_en: "Açaí bowl with guaraná syrup and banana", category: "frutas_e_derivados",
    nutrients_per_100g: { calories_kcal: 145, protein_g: 1.5, carbohydrates_g: 22.5, fat_g: 5.8, fiber_g: 2.0, sugar_g: 16.0, sodium_mg: 8 },
    common_serving: { label_pt: "1 tigela (~300g)", grams: 300 },
    aliases: ["açaí na tigela", "acai na tigela", "açaí bowl", "acai bowl", "tigela de açaí"] },
  { taco_id: 393, name_pt: "Cupuaçu, polpa, congelada", name_en: "Cupuaçu pulp, frozen", category: "frutas_e_derivados",
    nutrients_per_100g: { calories_kcal: 49, protein_g: 1.0, carbohydrates_g: 11.0, fat_g: 0.3, fiber_g: 3.0, sugar_g: 7.5, sodium_mg: 4 },
    common_serving: { label_pt: "1 porção (~100g)", grams: 100 },
    aliases: ["cupuaçu", "cupuacu", "polpa de cupuaçu"] },

  // --- Alimentos industrializados / doces (regional candies and desserts) ---
  { taco_id: 615, name_pt: "Beijinho, doce de coco", name_en: "Beijinho (coconut truffle)", category: "alimentos_industrializados",
    nutrients_per_100g: { calories_kcal: 405, protein_g: 5.0, carbohydrates_g: 60.0, fat_g: 16.5, sugar_g: 53.0, sodium_mg: 78 },
    common_serving: { label_pt: "1 unidade (~20g)", grams: 20 },
    aliases: ["beijinho", "branquinho", "coconut truffle"] },
  { taco_id: 616, name_pt: "Quindim", name_en: "Quindim (egg yolk and coconut custard)", category: "alimentos_industrializados",
    nutrients_per_100g: { calories_kcal: 320, protein_g: 5.8, carbohydrates_g: 50.0, fat_g: 11.5, sugar_g: 45.0, sodium_mg: 38 },
    common_serving: { label_pt: "1 unidade (~50g)", grams: 50 },
    aliases: ["quindim", "quindim baiano"] },
  { taco_id: 617, name_pt: "Pudim de leite condensado", name_en: "Pudim de leite (condensed milk caramel flan)", category: "alimentos_industrializados",
    nutrients_per_100g: { calories_kcal: 230, protein_g: 5.6, carbohydrates_g: 39.0, fat_g: 6.0, sugar_g: 38.0, sodium_mg: 65 },
    common_serving: { label_pt: "1 fatia (~120g)", grams: 120 },
    aliases: ["pudim", "pudim de leite", "pudim de leite condensado", "flan"] },
  { taco_id: 618, name_pt: "Goiabada cascão", name_en: "Goiabada (guava paste)", category: "alimentos_industrializados",
    nutrients_per_100g: { calories_kcal: 295, protein_g: 0.6, carbohydrates_g: 75.0, fat_g: 0.1, fiber_g: 2.6, sugar_g: 70.0, sodium_mg: 12 },
    common_serving: { label_pt: "1 fatia (~30g)", grams: 30 },
    aliases: ["goiabada", "goiabada cascão", "guava paste"] },
  { taco_id: 619, name_pt: "Cocada branca", name_en: "Cocada (coconut sugar candy)", category: "alimentos_industrializados",
    nutrients_per_100g: { calories_kcal: 410, protein_g: 2.5, carbohydrates_g: 70.5, fat_g: 14.5, fiber_g: 4.5, sugar_g: 60.0, sodium_mg: 26 },
    common_serving: { label_pt: "1 unidade (~30g)", grams: 30 },
    aliases: ["cocada", "cocada branca", "coconut candy", "coconut sweet"] },
  { taco_id: 621, name_pt: "Paçoca de amendoim, doce", name_en: "Paçoca (peanut and sugar candy)", category: "alimentos_industrializados",
    nutrients_per_100g: { calories_kcal: 484, protein_g: 16.5, carbohydrates_g: 52.0, fat_g: 22.0, fiber_g: 5.0, sugar_g: 38.0, sodium_mg: 14 },
    common_serving: { label_pt: "1 unidade (~20g)", grams: 20 },
    aliases: ["paçoca", "pacoca", "paçoca de amendoim", "peanut paçoca"] },
];
